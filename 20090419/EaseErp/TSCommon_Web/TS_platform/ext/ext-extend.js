 ...
 *   
 * 二、支持对树的级联<SPAN class=hilite2><SPAN class=hilite2>多选</SPAN></SPAN>   
 ...
 *   
 * 默认情况下，checkModel为'multiple'，也就是<SPAN class=hilite2><SPAN class=hilite2>多选</SPAN></SPAN>，onlyLeafCheckable为false，所有结点都可选  
 *   
 * 使用方法：在loader里加上 baseAttrs:{uiProvider:Ext.tree.TreeCheckNodeUI} 既可.  
 * 例如：  
 *   var tree = new Ext.tree.<SPAN class=hilite1><SPAN class=hilite1>TreePanel</SPAN></SPAN>({  
 *      el:'tree-ct',  
 *      width:568,  
 *      height:300,  
 *      checkModel: 'cascade',   //对树的级联<SPAN class=hilite2><SPAN class=hilite2>多选</SPAN></SPAN>  
...
Ext.tree.TreeCheckNodeUI = function() {   
    //'multiple':<SPAN class=hilite2><SPAN class=hilite2>多选</SPAN></SPAN>; 'single':单选; 'cascade':级联<SPAN class=hilite2><SPAN class=hilite2>多选</SPAN></SPAN>   
