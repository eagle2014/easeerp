<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleView.aspx.cs" Inherits="TSCommon.Web.Security.RoleView" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="<%=ContextPath %>/Security/js/RoleView.js"></script>
