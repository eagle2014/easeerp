<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ModelView.aspx.cs" Inherits="TSCommon.Web.Security.ModelView" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="<%=ContextPath %>/Security/js/ModelView.js"></script>
