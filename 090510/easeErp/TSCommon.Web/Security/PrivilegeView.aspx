<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PrivilegeView.aspx.cs"
    Inherits="TSCommon.Web.Security.PrivilegeView" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="<%=ContextPath %>/Security/js/PrivilegeView.js"></script>
