<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentForm.aspx.cs" Inherits="TSCommon.Web.Organize.DepartmentForm" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="<%=ContextPath %>/Organize/js/DepartmentForm.js"></script>
</head>
                                ...
                                <table width="100%" cellpadding="1" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="egd-property">
                                            <asp:TextBox ID="UnitFullName" CssClass="egd-form-zdField" runat="server" Width="600px"
                                                ReadOnly="true"></asp:TextBox>
                                            <img id="ImgBtnSelectOU" alt="选择所属单位" style="vertical-align: middle; cursor: hand"
                                                src="../TS_platform/images/select/search.gif" runat="server" onclick="thisPage.selectUpper('DW')" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="egd-form-label">
                                            上级部门：</td>
                                        <td colspan="3" class="egd-property">
                                            <asp:TextBox ID="ParentOUName" CssClass="egd-form-zdField" runat="server" Width="580px" ReadOnly="true"></asp:TextBox>
                                            <img id="ImgBtnSelectUpper" alt="选择上级部门" style="vertical-align: middle; cursor: pointer"
                                                src="../TS_platform/images/select/search.gif" runat="server" onclick="thisPage.selectUpper('BM',$F('UnitUnid'),$F('UnitName'))" /><img
                                                    id="ImgBtnClear" alt="清除上级部门" style="vertical-align: middle; cursor:pointer" src="../TS_platform/images/select/del.gif"
                                                    runat="server" onclick="thisPage.clearUpper()" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="egd-form-label">
