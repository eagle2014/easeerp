...
var thisPage = {
        ...
        this.toolbar=new TS.TB("tbContainer",[
		    "|",
		    {
			    ...
			    handler:function(button){
		            ...
		            TS.openWindow({
		                url: TS.rootPath +"wHUnitAction.do?action=Create", 
		                title: "新建单位",
		                id: "CreateUnit"
		            });
			    },
	...
	initGrid: function(){
        ...
        dataGrid = new TS.Grid("gridContainer",{
	 	    data: TS.rootPath + "wHUnitAction.do?action=View",
	 	    reader: {root: 'rows',totalProperty: 'totalCount',id: 'ID'},
	 	    cm:[
	 		    {id: "Name",text: "名称", width: 50},
	 		    {id: "Code",text: "编码", render: renderHref},
		    ...
		    dblClickRowHandler:function(id,rowData,row){
                ...
                TS.openWindow({
                    url: TS.rootPath +"wHUnitAction.do?action=Open&id=" + id, 
                    title: "单位：" + row.Name,
                    id: row.Unid,
	...
	doDelete: function(){
        ...
        TS.Msg.confirm({title:"单位配置",msg:"确定要删除选中的单位信息吗？",onYes: function(){
            // 通过Ajax执行删除操作    
            var strUrl = TS.rootPath +"wHUnitAction.do?action=Delete";
...
function renderHref(value,rowData,rowJson){
	...
	_href += "TS.openWindow({url:\"" + TS.rootPath + "wHUnitAction.do?action=Open&id=" + rowJson.ID + "\",";
