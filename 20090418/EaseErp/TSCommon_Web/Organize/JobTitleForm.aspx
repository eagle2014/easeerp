<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTitleForm.aspx.cs" Inherits="TSCommon_Web.Organize.JobTitleForm" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="<%=ContextPath %>/Organize/js/JobTitleForm.js"></script>
                                ...
                                <table width="100%" cellpadding="1" cellspacing="2">
                                    ...
                                    <tr>
                                        <td class="egd-form-label">
                                            级&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
                                        <td class="egd-property">
                                             <asp:DropDownList ID="Level" runat="server" CssClass="egd-form-field" onchange="thisPage.changeLevel()">
                                            </asp:DropDownList>
                                        </td>
                                        <td class="egd-form-label">
                                        </td>
