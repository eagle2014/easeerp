<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Default.aspx.cs" Inherits="TSCommon_Web.TS_MainPage._Default" %>
        ...
        <div class="top-warp">
            ...
            <div class="top-right">
                ...
                <div class="top-infoText">
                    当前用户：<a href="javascript:showMe()" class="top-userText"><%= TSCommon_Core.TSWebContext.TSWEBContext.Current.CurUser.Name %></a>
                    部门：<span class="top-deptText"><%= TSCommon_Core.TSWebContext.TSWEBContext.Current.CurUser.OUName%></span>
                </div>
            </div>
        </div>
        <div class="topbottom">
...
function showMe(){
	openWindow({
	    ...
	    title: '<%= TSCommon_Core.TSWebContext.TSWEBContext.Current.CurUser.Name %>',
