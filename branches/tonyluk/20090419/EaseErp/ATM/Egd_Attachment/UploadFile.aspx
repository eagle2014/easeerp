<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UploadFile.aspx.cs" Inherits="Egrand.Attachment.Web.UploadFile" %>
...
<head runat="server">
    ...
    <egdScript:IncludeCSS Href="~/egd_platform/css/Page.css" runat="server" />
    ...
    <egdScript:IncludeCSS Href="css/default/attachment.css" runat="server" />
</head>
            ...
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">
              <tr>
                ...
                <a id="container1" class="addfile" style="border:0px; cursor:pointer;">
                    <input  id="File1" name="file_0" type="file" style="width: 0px;" class="addfile" onChange="createnew();" runat="server" />
                </a>
                </div>
                </td>
              </tr>
...
function init(){
    ...
    if(errorMsg.length > 0){
        Egd.Msg.msgBox(errorMsg);
    }else{
        if(atms)    // 表单提交成功
            Egd.Dlg.fireButtonEvent(0,'egdUploadFileDlg')
    }
}
